...
public class LineService {
    ...
    public LineTempResponse save(final LineDto lineDto, final SectionCreateDto sectionCreateDto) { // 결국 Line 에서 Section 을 만들어주는 역할을 진행해야함.
        ...
        return LineTempResponse.from(lineRepository.save(line));
    }
//
